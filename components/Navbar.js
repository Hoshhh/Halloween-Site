  ...
  return (
    <nav>
        <div className="max-w-8xl  mx-auto py-6">
            <div className="flex justify-between items-center text-dark-orange">
                <div> 
                    <xml version="1.0" encoding="utf-8" />
                    <svg version="1.1" className="fill-dark-orange drop-shadow-svg animate-pulse w-16 h-16" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
