            ...
            <div className="flex justify-between items-center text-white cursor-pointer">
                ...
                <div className="hidden md:block">
                    <div className="flex space-x-4 text-2xl font-bold animate-pulse ">
                        <Link className="hover:text-light-orange flex items-center" href="/home">
                            <div className="flex">
                        ...
                        <Link className="hover:text-light-orange flex items-center" href="/videos">
                            <div className="flex">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                        ...
                        <Link className="hover:text-light-orange flex items-center" href="/movies">
                            <div className="flex">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                        ...
                        <Link className="hover:text-light-orange flex items-center" href="/costumes">
                            <div className="flex">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                        ...
                        <Link className="hover:text-light-orange flex items-center" href="/games">
                            <div className="flex">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
